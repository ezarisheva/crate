...
public class ManyTableConsumerTest extends CrateDummyClusterServiceUnitTest {
    ...
    public void testFindFirstJoinPair() {
        ...
        assertThat(ManyTableConsumer.getFirstJoinPair(occurrences, sets), is(ImmutableSet.of(T3.T2, T3.T3)));
    }
    ...
    public void testFindFirstJoinPairOnlyOneOccurrence() {
        ...
        assertThat(ManyTableConsumer.getFirstJoinPair(occurrences, sets), is(ImmutableSet.of(T3.T1, T3.T2)));
    }
